  ...
  module IngredientsHelper
    ...
    def format_habanero_nest_ingredient(target, ingredient)
      ingredient_span(ingredient) do 
        ...
        link_to v, page_path(@placement.scoop.page, :id => v, :variety_type => ingredient.variety) if v
      end
=begin
      ingredient_span(ingredient) do 
        content_tag(:dl) do
...
=end
        ...
        link_to v, page_path(@placement.scoop.page, :id => v, :variety_type => ingredient.inverse_variety) if v
      end
    end
